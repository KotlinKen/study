...
public class Study {
	...
	public Study(int sno, int mno, int kno, int tno, int lno, String title, String freq, String content, String price,
	...
	public String toString() {
		return "Study [sno=" + sno + ", mno=" + mno + ", kno=" + kno + ", tno=" + tno + ", lno=" + lno + ", title="
