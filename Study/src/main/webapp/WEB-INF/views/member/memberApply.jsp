...
<style>
	...
	%>
	<%=com.pure.study.common.util.Utils.getPageBar(totalContents, cPage, numPerPage,"searchMyApplyKwd.do?searchKwd="+searchKwd+"&kwd="+kwd+"&type="+type+"&applyDate="+applyDate) %>
